...
public class EntitySpeedBoat extends Entity
{
    ...
    public EntitySpeedBoat(World par1World)
    {
        ...
        this.texture = "/mods/SpeedBoats/textures/speedboat.png";
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if (!this.worldObj.isRemote && !this.isDead)
        {
            ...
            if (flag || this.getDamageTaken() > 40)
            {
                ...
                if (!flag)
                {
                    this.dropItemWithOffset(SpeedBoats.speedBoat.itemID, 1, 0.0F);
                }
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            if (this.riddenByEntity != null)
            {
            	if(this.isGoingFast)
            	{
            		this.motionX += this.riddenByEntity.motionX * 10.199999999999999D;
                    this.motionZ += this.riddenByEntity.motionZ * 10.199999999999999D;
            	}
            	else
            	{
				...
				if(this.isJumping)
				{
					this.motionY += this.riddenByEntity.motionY * 0.10000000000000001D;
				}
            }
